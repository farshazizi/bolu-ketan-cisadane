                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group d-flex justify-content-end mt-5">
                                                <button type="button" class="btn btn-primary" v-on:click="addStockIn">
                                                    Tambah Stok Masuk
                                                </button>
                                            </div>
...
@section('content-js')
    <script type="text/javascript">
        let storeRoute = "{{ route('stocks.stocks_in.store') }}";
    </script>
    <script type="text/javascript" src="{{ asset('js/contents/masters/stocks/stock-in/stock-in-create-vue.js') }}">
    </script>
@endsection
