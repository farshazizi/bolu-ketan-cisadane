                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @endif
                            <form class="form form-vertical" action="{{ route('stocks.stocks-out.store') }}"
                                method="POST">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group d-flex justify-content-end mt-5">
                                                <button type="button" class="btn btn-primary" id="btnAddStockOut">
                                                    Tambah Stok Keluar
                                                </button>
                                            </div>
